...
//	private Future<Double> mFutureValue;
	...
	public void buildClusterer(Instances data) throws Exception {
		...
		Instances delIns = new Instances(instances,0);
...
*/
	...
	public Instances getFullCentroids(){
		...
		Instances centroids = new Instances(firstCentroid.dataset());
		Instances second = new Instances(delIns,cap/2,cap);
		Instance secondCentroid = new DenseInstance(1.0,calculateCentroid(second));
		centroids.add(secondCentroid);
		centroids.add(mCentroid);
		return centroids;
	}
	...
	public static void main(String[] args) {
		...
		String Path = "/home/ucas/software/aluminum-electrolysis/CSV日报/3000.arff";
		AluBiCluster abc = new AluBiCluster();
		try {
			abc.buildClusterer(ld.loadData(Path));
		} catch (Exception e) {
