...
//	int dizi1[] = new int[10];
	 ...
	 * vector holding dimension parameters to be optimized. The number of rows of foods
	...
	/*
	 * a function pointer returning double and taking a dimension-dimensional array as
	 * argument
	 */
	/*
